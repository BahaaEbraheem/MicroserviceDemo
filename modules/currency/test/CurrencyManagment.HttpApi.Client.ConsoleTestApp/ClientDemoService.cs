...
public class ClientDemoService : ITransientDependency
{
    ...
    public async Task RunAsync()
    {
        ...
        { 
            var productAppService = channel.CreateGrpcService<ISampleAppService>();
            var productDto = await productAppService.GetAsync(); 
           
                Console.WriteLine($"[Product] Name = {productDto.Value}");
